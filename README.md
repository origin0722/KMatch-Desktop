...
> 赛题 XH-202630 ｜ 单人全栈 ｜ **正式版 v1.3.3** ｜ Windows 桌面 IDE
...
> 📦 正式版发行物：`KMatch·知链-1.3.3-x64.exe` — [GitHub Release v1.3.3](https://github.com/origin0722/KMatch-Desktop/releases/tag/v1.3.3)
...
产物 `release/KMatch·知链-1.3.3-x64.exe`，装后 sidecar 自启；**端用户免 Docker**。首次打包需开 Windows 开发者模式（winCodeSign 符号链接）。详见 [CLAUDE.md](CLAUDE.md)。
