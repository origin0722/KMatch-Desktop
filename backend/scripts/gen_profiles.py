...
2026-08-11 修复: age_range 参数化 (原硬编码 "18-30" 违反 schema enum),
estimated_weeks -> estimated_completion_weeks (对齐 schema 字段名)。
"""
...
def _base(profile_id, name, type_, desc, theory, practical, style, target,
          ...
          age_range, test_correct, style_quiz):
    ...
    return {
        ...
        "learning_history": [],
        "recommended_path": {"current_node": "PY-001", "next_nodes": [], "estimated_completion_weeks": 4},
    }
...
def main():
    profiles = [
        _base(
            ...
            "18-25", 2, {"visual": 4, "auditory": 2, "read_write": 2, "kinesthetic": 1},
        ),
        _base(
            ...
            "26-35", 4, {"visual": 2, "auditory": 1, "read_write": 4, "kinesthetic": 2},
        ),
        _base(
            ...
            "18-25", 6, {"visual": 2, "auditory": 1, "read_write": 3, "kinesthetic": 3},
        ),
        _base(
            ...
            "18-25", 7, {"visual": 3, "auditory": 1, "read_write": 3, "kinesthetic": 2},
        ),
        _base(
            ...
            "18-25", 8, {"visual": 3, "auditory": 1, "read_write": 2, "kinesthetic": 3},
        ),
        _base(
            ...
            "<18", 3, {"visual": 2, "auditory": 1, "read_write": 1, "kinesthetic": 4},
        ),
        _base(
            ...
            "26-35", 9, {"visual": 1, "auditory": 1, "read_write": 5, "kinesthetic": 2},
        ),
    ]
    ...
    for p in profiles:
        ...
        print(f"✔ 生成 {path.name} (理论{p['theory_level']}级/实践{p['practical_level']}级/年龄{p['demographics']['age_range']})")
