...
| [质量与验收](质量与验收/) | M5 质检、审查报告、测试用例 | [质量检测报告.md](质量与验收/质量检测报告.md)、[体验审查报告_v1.3.3.md](质量与验收/体验审查报告_v1.3.3.md)、[测试用例表_v1.3.3.md](质量与验收/测试用例表_v1.3.3.md)、[测试数据说明_v1.3.3.md](质量与验收/测试数据说明_v1.3.3.md) |
| [部署与发布](部署与发布/) | 部署/打包/发布 | [系统部署说明_v1.3.3.md](部署与发布/系统部署说明_v1.3.3.md) |
...
| [交付材料](交付材料/) | 赛题提交材料 | [提交材料_视频脚本与方案大纲.md](交付材料/提交材料_视频脚本与方案大纲.md)、[软件说明_v1.3.0.md](交付材料/软件说明_v1.3.0.md)、[测试数据_输入输出示例.md](交付材料/测试数据_输入输出示例.md)、[真机核验清单_v1.0.0.md](交付材料/真机核验清单_v1.0.0.md) |
