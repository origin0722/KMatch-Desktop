...
| [部署与发布](部署与发布/) | 部署/打包/发布 | [系统部署说明_v1.4.0.md](部署与发布/系统部署说明_v1.4.0.md)（v1.3.4 版仍在） |
...
| [交付材料](交付材料/) | 赛题提交材料 | [提交材料_视频脚本与方案大纲.md](交付材料/提交材料_视频脚本与方案大纲.md)、[软件说明_v1.4.0.md](交付材料/软件说明_v1.4.0.md)（终版）、[真机核验清单_v1.3.4.md](交付材料/真机核验清单_v1.3.4.md)、[测试数据_输入输出示例.md](交付材料/测试数据_输入输出示例.md) |
