...
### 3.10 模型名更新 + 思考过程可见
- 模型名：已另写调研文档 [docs/研究与调研/模型更新调研_2026-08.md](模型更新调研_2026-08.md)（含各厂商最新模型建议），落代码前需线上核实。
...
聊天核心 chunk（325/329/24/954）从本网络 404，思考气泡的具体排版/动画未解析；如需 1:1 对照建议浏览器打开 `ai.explore.poker/chat` 目测。模型命名情报（`deepseek-v4-pro-202606`、`qwen3.5-plus` 等）已与 [docs/研究与调研/模型更新调研_2026-08.md](模型更新调研_2026-08.md) 呼应，可佐证型号存在性。
